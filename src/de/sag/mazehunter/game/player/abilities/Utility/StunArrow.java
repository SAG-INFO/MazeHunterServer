...
public class StunArrow extends Ability{
    ...
    public void use(int connectionID, float angle) {
        ...
        Main.MAIN_SINGLETON.game.world.entityManager.entities.add(new StunArrowEntity(fVelocity, Main.MAIN_SINGLETON.game.player[index].position.cpy(), Config.STUNARROW_HITBOXRADIUS2, projectileID, connectionID));
